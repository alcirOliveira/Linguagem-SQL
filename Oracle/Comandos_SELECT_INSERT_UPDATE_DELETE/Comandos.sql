...
CREATE TABLE cadastroDVD ( 
   id_cad_DVD NUMBER(3) NOT NULL PRIMARY KEY, 
   titulo_DVD CHAR(20) NOT NULL,
   preco_DVD NUMBER(5,2) NOT NULL 
);

-- Comando para verificar a estrutura da tabela
DESCRIBE cadastroDVD;

-- Inserindo os dados na tabela
INSERT INTO cadastroDVD VALUES ( 100, 'Lua Nova',           ' 39,90 ' ); -- o preço pode ser inserido sem aspa, mas com ponto no lugar da vírgula
